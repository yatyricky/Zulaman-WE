...
#Jan 29 2015
Started to gitify this project.
...
//          Progressbar V2
//      @Description:
//          Model, that is meant to be used for various channeling spells and 
//          etc. Basic lenght is one second, but it can be scaled via triggers.
//          Idea of using screen button texture is borrowed from Hatebreeder's 
//          model, you might want to give him credits too.
//      @Link:
