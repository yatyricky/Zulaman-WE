...
library ShadowShift requires DamageSystem {
    ...
    function onCast() {
        ...
        HealTarget(SpellEvent.CastingUnit, SpellEvent.CastingUnit, GetUnitState(SpellEvent.CastingUnit, UNIT_STATE_MAX_LIFE) * 0.2, SpellData.inst(SID_SHADOW_SHIFT, SCOPE_PREFIX).name, 0.0);
