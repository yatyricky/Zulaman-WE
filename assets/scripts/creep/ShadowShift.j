...
library ShadowShift requires DamageSystem {
    ...
    function onCast() {
        ...
        DamageTarget(SpellEvent.CastingUnit, SpellEvent.TargetUnit, amt, SpellData.inst(SID_SHADOW_SHIFT, SCOPE_PREFIX).name, false, false, false, WEAPON_TYPE_WHOKNOWS, false);   
