...
constant string  ART_TARGET  = "Abilities\\Weapons\\FrostWyrmMissile\\FrostWyrmMissile.mdl";
    ...
    function onCast() {
        ...
        DamageTarget(SpellEvent.CastingUnit, SpellEvent.TargetUnit, 200.0, SpellData.inst(SID_FROST_SHOCK, SCOPE_PREFIX).name, false, true, false, WEAPON_TYPE_WHOKNOWS, false);   
