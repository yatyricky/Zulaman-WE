...
public constant integer BID_HEAL_AMP = 'A00U';
public constant integer SID_DISPEL = 'A00R';
public constant integer BID_DISPEL = 'A03U';
...
public constant integer UTID_THURG = 'nogo';
public constant integer UTID_GAZAKROTH = 'nlv1';
public constant integer SID_FIRE_BOLT = 'A01B';
public constant integer UTID_LORD_RAADAN = 'nbdm';
public constant integer SID_FIRE_NOVA = 'A01E';
public constant integer BID_FireNova = 'A00F';
public constant integer UTID_DARKHEART = 'uban';
public constant integer SID_PSYCHIC_WAIL = 'A01P';
public constant integer BID_PsychicWail = 'A00H';
public constant integer UTID_ALYSON_ANTILLE = 'hsor';
public constant integer SID_FAST_HEAL = 'A01T';
public constant integer UTID_SLITHER = 'nskk';
public constant integer SID_SLUG = 'A026';
public constant integer BID_Slug = 'A00P';
public constant integer UTID_FENSTALKER = 'nsqt';
public constant integer BID_BreakLeg = 'A00T';
public constant integer UTID_KORAGG = 'u005';
public constant integer SID_COLD_GAZE = 'A028';
public constant integer BID_ColdGaze = 'A019';
...
public constant integer SID_SUMMON_FILTHY_TENTACLE = 'A02T';
public constant integer SID_FILTHY_TENTACLE_DRAG = 'A0FH';
public constant integer BID_FILTHY_TENTACLE_DRAG = 'A0FI';
public constant integer SID_PSYCHIC_LINK = 'A02U';
public constant integer SID_SUMMON_VICIOUS_TENTACLE = 'A02V';
public constant integer SID_VICIOUS_TENTACLE_STUN = 'A0FL';
public constant integer BID_VICIOUS_TENTACLE_STUN = 'A0FJ';
public constant integer SID_EYE_BEAM = 'A033';
public constant integer SID_SUMMON_FOUL_TENTACLE = 'A0D8';
public constant integer BID_BEFOULED = 'A0FK';
...
public constant integer ITID_SHINING_JEWEL_OF_TANARIS = 'I02N';
public constant integer ITID_DRAKKARI_DECAPITATOR = 'I02O';
...
public constant integer ITID_GURUBASHI_VOODOO_VIALS = 'I00P';
...
public constant integer SID_MOONLIGHT_GREATSWORD_EXPLOSION = 'dmge';
...
public constant integer ITID_ZULS_STAFF = 'I02P';
...
public constant integer IATTR_MD_ARCANE = 99;
...
public constant integer IATTR_SET_ZANDALARI = 98;
...
public constant integer SUFIX_VAMPIRE = 39;
public constant integer SUFIX_SUCCUBUS = 40;
...
public constant string ART_GlowingRunes0 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes0.mdl"; // red
public constant string ART_GlowingRunes1 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes1.mdl"; // teal
public constant string ART_GlowingRunes2 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes2.mdl"; // white
public constant string ART_GlowingRunes3 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes3.mdl"; // yellow
public constant string ART_GlowingRunes4 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes4.mdl"; // light blue
public constant string ART_GlowingRunes5 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes5.mdl"; // magenta
public constant string ART_GlowingRunes6 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes6.mdl"; // green
public constant string ART_GlowingRunes7 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes7.mdl"; // violet
public constant string ART_GlowingRunes8 = "Doodads\\Cinematic\\GlowingRunes\\GlowingRunes8.mdl"; // golden
