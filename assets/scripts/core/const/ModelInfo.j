...
ModelInfo.rg(UTID_UNHOLY_TENTACLE,ATT_NON,19999,100,300,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_FILTHY_TENTACLE,ATT_NON,49999,100,200,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_VICIOUS_TENTACLE,ATT_NON,49999,100,200,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_FOUL_TENTACLE,ATT_NON,49999,100,200,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_ROOT_OF_FILTH,ATT_NON,199999,20,30,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_ROOT_OF_VICIOUSNESS,ATT_NON,199999,20,30,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_ROOT_OF_FOULNESS,ATT_NON,199999,20,30,0,0,0,0,1,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNTentacle.blp");
ModelInfo.rg(UTID_ETERNAL_GUARDIAN,ATT_NON,999999,800,200,75,0,0,0,0.25,0,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNFacelessOne.blp");
...
ModelInfo.rg(UTID_WIND_SERPENT,ATT_NON,23999,275,125,7,0.1,0,0,1,0.1,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNWindSerpent.blp");
...
ModelInfo.rg(UTID_CHMP_NAGA_MYRMIDON,ATT_NON,23999,200,200,15,0.05,0.1,30,1,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNNagaMyrmidon.blp");
ModelInfo.rg(UTID_NAGA_ROYAL_GUARD,ATT_NON,39999,300,150,15,0.05,0.1,30,1,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNNagaMyrmidonRoyalGuard.blp");
ModelInfo.rg(UTID_CHMP_NAGA_ROYAL_GUARD,ATT_NON,39999,300,150,15,0.05,0.1,30,1,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNNagaMyrmidonRoyalGuard.blp");
ModelInfo.rg(UTID_FEL_PEON,ATT_NON,26499,420,180,5,0.05,0.05,0,1,0.01,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNChaosPeon.blp");
ModelInfo.rg(UTID_FEL_GRUNT,ATT_NON,44999,650,300,5,0.05,0.05,100,0.95,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNChaosGrunt.blp");
ModelInfo.rg(UTID_FEL_RIDER,ATT_NON,39999,600,200,10,0.05,0,0,1,0.1,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNChaosWolfRider.blp");
ModelInfo.rg(UTID_FEL_WAR_BRINGER,ATT_NON,69999,750,150,5,0.05,0.15,240,0.8,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNChaosKotoBeast.blp");
ModelInfo.rg(UTID_CHMP_FEL_WAR_BRINGER,ATT_NON,69999,750,150,5,0.05,0.15,240,0.8,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNChaosKotoBeast.blp");
ModelInfo.rg(UTID_DEMONIC_WITCH,ATT_NON,31999,400,200,5,0.05,0,0,1,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNChaosWarlock.blp");
...
ModelInfo.rg(UTID_PARASITICAL_ROACH,ATT_NON,9999,300,100,0,0.05,0,0,0.95,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNCarrionScarabs.blp");
...
ModelInfo.rg(UTID_CHMP_DRACOLICH,ATT_NON,124999,800,200,10,0.05,0,0,0.9,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNFrostWyrm.blp");
...
ModelInfo.rg(UTID_CHMP_INFERNO_CONSTRUCT,ATT_NON,219999,900,300,10,0.05,10,150,1,0.1,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNInfernal.blp");
...
ModelInfo.rg(UTID_CHMP_GARGANTUAN,ATT_NON,219999,1200,300,10,0.05,0,0,0.9,0.05,CAREER_TYPE_CREEP,"ReplaceableTextures\\CommandButtons\\BTNAbomination.blp");
