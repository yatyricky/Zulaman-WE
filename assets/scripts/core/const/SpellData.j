...
SpellData.create(SID_REND,"Rend",30,0,6,OrderId("whirlwind"),1,ORDER_TYPE_TARGET);
...
SpellData.create(SID_FROST_NOVA,"Frost Nova",70,0,15,OrderId("frostnova"),1,ORDER_TYPE_IMMEDIATE);
...
SpellData.create(SID_SPELL_TRANSFER,"Spell Transfer",70,0,6,OrderId("dispel"),1,ORDER_TYPE_TARGET).setCCC2(210,0,3).setCCC3(350,0,1);
SpellData.create(SID_INTELLIGENCE_CHANNEL,"Intelligence Channel",0,0,1,OrderId("channel"),1,ORDER_TYPE_TARGET);
