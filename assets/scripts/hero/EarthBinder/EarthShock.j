...
library EarthShock requires DamageSystem, SpellData, BuffSystem {
    ...
    function onCast() {
        ...
        DamageTarget(SpellEvent.CastingUnit, SpellEvent.TargetUnit, dmg, SpellData.inst(SID_EARTH_SHOCK, SCOPE_PREFIX).name, false, true, false, WEAPON_TYPE_WHOKNOWS, true);
