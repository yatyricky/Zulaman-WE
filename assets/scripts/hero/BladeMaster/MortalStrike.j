...
constant string  ART_CASTER  = "Abilities\\Spells\\Other\\Andt\\Andt.mdl";
    ...
    function onCast() {
        ...
        DamageTarget(SpellEvent.CastingUnit, SpellEvent.TargetUnit, dmg, SpellData.inst(SID_MORTAL_STRIKE, SCOPE_PREFIX).name, true, true, true, WEAPON_TYPE_METAL_HEAVY_SLICE, true);
