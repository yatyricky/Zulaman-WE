    ...
    struct ItemAttributesMeta {
        ...
        static method onInit() {
            ...
            TimerStart(CreateTimer(), 0.7, false, function() {
                ...
                thistype.create(ITID_DYING_BREATH,"|cffff8c00Dying Breath|r","|cffffdeadThe master piece by Griswold the Undead. On the unglazed handle six obscure runes glow: Vex-Hel-El-Eld-Zod-Eth.|r").append(7,4,7).append(9,5,10).append(12,3,5).append(44,0.02,0.04).append(50,18,23);
                ...
                thistype.create(ITID_THUNDERFURY_BLESSED_BLADE_OF_THE_WINDSEEKER,"|cffff8c00Thunderfury, Blessed Blade of the Windseeker|r","").append(13,6,13).append(21,75,150).append(57,10,30).append(89,50,120).append(62,0.03,0.07);
