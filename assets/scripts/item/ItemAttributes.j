    ...
    struct ItemAttributesMeta {
        ...
        static method onInit() {
            ...
            TimerStart(CreateTimer(), 0.7, false, function() {
                ...
                thistype.create(ITID_DYING_BREATH,"|cffff8c00Dying Breath|r","|cffffdeadThe master piece by Griswold the Undead. On the unglazed handle six obscure runes glow: Vex-Hel-El-Eld-Zod-Eth.|r").append(13,5,10).append(9,5,10).append(12,3,5).append(44,0.02,0.04).append(50,18,23);
