    ...
    struct ItemAttributesMeta {
        ...
        static method onInit() {
            ...
            TimerStart(CreateTimer(), 0.7, false, function() {
                ...
                thistype.create(ITID_RAGE_WINTERCHILLS_PHYLACTERY,"|CFF8B66FFRage Winterchill's Phylactery|R","|CFFFFDEADFor some people, the value of his phylactery is greater than the Chronicle of Dark Secrets.|R").append(14,5,8).append(21,70,90).append(20,2,3).append(96,0.03,0.04).append(70,0.01,0.02);
