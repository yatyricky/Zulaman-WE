...
library ItemAttributes requires UnitProperty, List, BreathOfTheDying, WindForce, Infinity, ConvertAttackMagic, MagicPoison, VoodooVial, RomulosExpiredPoison, Drum, MoonlightExplosion, NonHeroExtraDamage, AttackChanceICC, AttackBleed, AttackStun, LethalMagicalDamage, ArthassCorruption, IconOfTheUnglazedCrescent, ArcanePotion {
    ...
    struct ItemAttributesMeta {
        ...
        static method onInit() {
            ...
            TimerStart(CreateTimer(), 0.7, false, function() {
                ...
                thistype.create(ITID_BREATH_OF_THE_DYING,"|cffff8c00Breath of the Dying|r","|cffffdeadThe master piece by Griswold the Undead. On the unglazed handle six obscure runes glow: Vex-Hel-El-Eld-Zod-Eth.|r").append(7,4,7).append(9,5,10).append(12,3,5).append(44,0.02,0.04).append(50,18,23);
    ...
    public struct AttributeBehaviourMeta[] {
        ...
        static method onInit() {
            ...
            thistype.put(IATTR_MD_CHAIN,2,452,0.7,"|cff33ff33Dealing Damage: 10% chance to cast Chain Lightning to target, dealing "," magical damage|r",thistype.callbackMD_CHAIN);
