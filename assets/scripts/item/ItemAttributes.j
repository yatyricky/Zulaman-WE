...
library ItemAttributes requires UnitProperty, ItemAffix, BreathOfTheDying {
    ...
    struct ItemAttributeMeta {
        ...
        static method onInit() {
            ...
            thistype.create(IATTR_BM_VALOR,200,"|cff33ff33Regenerates "," more valor points|r",thistype.callbackBM_VALOR);
            thistype.create(IATTR_RG_ONESHOT,201,"|cff33ff33One-shot target when it's HP is less than yours","|r",thistype.callbackRG_ONESHOT);
            thistype.create(IATTR_RG_RUSH,202,"|cff33ff33Deals "," extra damage to target below 30% max HP|r",thistype.callbackRG_RUSH);
            thistype.create(IATTR_CRKILLER,203,"|cff33ff33Deals "," extra damage to non-hero targets|r",thistype.callbackCRKILLER);
            thistype.create(IATTR_MCVT,204,"|cff33ff33Converts your normal attacks into magical damage","|r",thistype.callbackMCVT);
            thistype.create(IATTR_KG_REGRCD,205,"|cff33ff33Reduce cooldown of Instant Regrowth by "," seconds|r",thistype.callbackKG_REGRCD);
            thistype.create(IATTR_LEECHAURA,207,"|cff33ff33Absorb "," HP from all enemies nearby every second|r",thistype.callbackLEECHAURA);
            thistype.create(IATTR_PR_POHDEF,208,"|cff33ff33Prayer of healing increases armor of target by ","|r",thistype.callbackPR_POHDEF);
            thistype.create(IATTR_DR_MAXHP,210,"|cff33ff33Survival Instincts provides "," extra healing and max HP|r",thistype.callbackDR_MAXHP);
            thistype.create(IATTR_PL_SHOCK,211,"|cff33ff33Holy Shock always deals critical healing","|r",thistype.callbackPL_SHOCK);
            thistype.create(IATTR_PR_SHIELD,212,"|cff33ff33Removes weakness effect of Shield","|r",thistype.callbackPR_SHIELD);
            thistype.create(IATTR_CT_PAIN,213,"|cff33ff33Marrow Squeeze extends the Pain on target by "," seconds|r",thistype.callbackCT_PAIN);
            thistype.create(IATTR_BD_SHIELD,214,"|cff33ff33Shield of Sin'dorei provides "," extra damage reduction, and forces all nearby enemies to attack you|r",thistype.callbackBD_SHIELD);
            thistype.create(IATTR_RG_PARALZ,215,"|cff33ff33Sinister Strike has a "," chance to paralyze target, reduce target spell haste by 20% and gain an extra combo point|r",thistype.callbackRG_PARALZ);
            thistype.create(IATTR_PL_LIGHT,216,"|cff33ff33Flash Light dispels one debuff from target","|r",thistype.callbackPL_LIGHT);
            thistype.create(IATTR_DR_CDR,217,"|cff33ff33Reduce cooldown of Survival Instincts by "," seconds|r",thistype.callbackDR_CDR);
            thistype.create(IATTR_SM_LASH,218,"|cff33ff33Storm Lash has "," extra chance to cooldown Earth Shock|r",thistype.callbackSM_LASH);
            thistype.create(IATTR_DK_ARROW,219,"|cff33ff33Number of Dark Arrows increased by ","|r",thistype.callbackDK_ARROW);
            thistype.create(IATTR_MG_FDMG,220,"|cff33ff33Increase ice spell damage by ","|r",thistype.callbackMG_FDMG);
            thistype.create(IATTR_MG_BLZ,222,"|cff33ff33"," chance to cast an instant Frost Bolt to targets damaged by Blizzard|r",thistype.callbackMG_BLZ);
            thistype.create(IATTR_ATK_ML,400,"|cff33ff33On Attack: "," mana steal|r",thistype.callbackATK_ML);
            thistype.create(IATTR_ATK_LL,401,"|cff33ff33On Attack: "," life steal|r",thistype.callbackATK_LL);
            thistype.create(IATTR_ATK_LLML,402,"|cff33ff33On Attack: "," life and mana steal|r",thistype.callbackATK_LLML);
            ...
            thistype.create(IATTR_ATK_MOONWAVE,406,"|cff33ff33On Attack: 10% chance to consume 5% of max MP, deals "," magical damage to all enemies in a row|r",thistype.callbackATK_MOONWAVE);
            ...
            thistype.create(IATTR_ATK_COIL,408,"|cff33ff33On Attack: 15% chance to cast Death Coil, deals "," magical damage to target. Target takes 3% extra damge|r",thistype.callbackATK_COIL);
            ...
            thistype.create(IATTR_ATK_MDC,410,"|cff33ff33On Attack: 25% chance to deal "," magical damage to target|r",thistype.callbackATK_MDC);
            ...
            thistype.create(IATTR_ATK_MD,414,"|cff33ff33On Attack: Deals "," magical damage, scaled up by your attack power and spell power|r",thistype.callbackATK_MD);
            thistype.create(IATTR_ATK_MDK,415,"|cff33ff33On Attack: Deals "," magical damage, scaled up by target HP lost|r",thistype.callbackATK_MDK);
            ...
            thistype.create(IATTR_3ATK_MOONEXP,430,"|cff33ff33Every Third Attack: Consumes 5% of max MP, deals "," magical damage to all enemies nearby|r",thistype.callback3ATK_MOONEXP);
            thistype.create(IATTR_MD_MREGEN,450,"|cff33ff33Spell Damage: 1% chance to regen "," MP|r",thistype.callbackMD_MREGEN);
            thistype.create(IATTR_MD_POISON,451,"|cff33ff33Spell Damage: 10% chance to poison target, dealing "," magical damage over time|r",thistype.callbackMD_POISON);
            thistype.create(IATTR_MD_CHAIN,452,"|cff33ff33Spell Damage: 10% chance to cast Chain Lightning to target, dealing "," magical damage|r",thistype.callbackMD_CHAIN);
            thistype.create(IATTR_MDC_ARCANE,460,"|cff33ff33Spell Critical: Charges with arcane power. All arcane power will be released automatically after 3 stacks, dealing "," magical damage to target|r",thistype.callbackMDC_ARCANE);
            ...
            thistype.create(IATTR_HEAL_HOLY,700,"|cff33ff33On Healed: Charges 1 holy power","|r",thistype.callbackHEAL_HOLY);
            thistype.create(IATTR_AURA_CONVIC,800,"|cff33ff33Grant Aura of Conviction: All enemies within 600 yards take "," more magical damage|r",thistype.callbackAURA_CONVIC);
            ...
            thistype.create(IATTR_USE_TP,900,"|cff33ff33Use: Teleports to an ally","|r",thistype.callbackUSE_TP);
            ...
            thistype.create(IATTR_USE_VOODOO,904,"|cff33ff33Use: Deals "," magical damage to all enemies within range over time|r",thistype.callbackUSE_VOODOO);
