    ...
    struct ItemAttributesMeta {
        ...
        static method onInit() {
            ...
            TimerStart(CreateTimer(), 0.7, false, function() {
                ...
                thistype.create(ITID_RHOKDELAR,"|cff8b66ffRhokdelar|r","|cffffdeadLongbow of the Ancient Keepers|r").append(13,5,8).append(12,3,5).append(11,3,5).append(24,10,20).append(94,0.7,1);
