...
public constant real    ILVL_MAX_RATE = 0.6;
    ...
    function onInit() {
        ...
        rare.add(ITID_ARANS_SOOTHING_EMERALD, 48);
        rare.add(ITID_PURE_ARCANE, 36);
        rare.add(ITID_HEX_SHRUNKEN_HEAD, 36);
        rare.add(ITID_STAFF_OF_THE_SHADOW_FLAME, 36);
        rare.add(ITID_TIDAL_LOOP, 60);
        ...
        boss1.add(ITID_MAUL, 6);
        boss1.add(ITID_CLOAK, 5);
        boss1.add(ITID_SCEPTER, 6);
        boss1.add(ITID_COLOSSUS_BLADE, 8);
        boss1.add(ITID_THE_X_RING, 10);
        boss1.add(ITID_GOBLIN_ROCKET_BOOTS_LIMITED_EDITION, 16);
        boss1.add(ITID_CORE_HOUND_TOOTH, 4);
        boss1.add(ITID_VISKAG, 8);
        boss1.add(ITID_ARMOR_OF_THE_DAMNED, 6);
        boss1.add(ITID_BULWARK_OF_THE_AMANI_EMPIRE, 4);
        boss1.add(ITID_PURE_ARCANE, 8);
        boss1.add(ITID_HEX_SHRUNKEN_HEAD, 3);
        boss1.add(ITID_STAFF_OF_THE_SHADOW_FLAME, 6);
        boss1.add(ITID_TIDAL_LOOP, 4);
        boss1.add(ITID_EAGLE_GOD_GAUNTLETS, 6);

        boss2.add(ITID_CLOAK, 14);
        boss2.add(ITID_COLOSSUS_BLADE, 5);
        boss2.add(ITID_THE_X_RING, 6);
        boss2.add(ITID_TROLL_BANE, 6);
        boss2.add(ITID_LION_HORN, 14);
        boss2.add(ITID_ARMOR_OF_THE_DAMNED, 2);
        boss2.add(ITID_ARANS_SOOTHING_EMERALD, 6);
        boss2.add(ITID_PURE_ARCANE, 8);
        boss2.add(ITID_HEX_SHRUNKEN_HEAD, 6);
        boss2.add(ITID_STAFF_OF_THE_SHADOW_FLAME, 8);
        boss2.add(ITID_TIDAL_LOOP, 9);
        boss2.add(ITID_EAGLE_GOD_GAUNTLETS, 8);
        boss2.add(ITID_MOONSTONE, 8);

        boss3.add(ITID_MAUL, 7);
        boss3.add(ITID_COLOSSUS_BLADE, 4);
        boss3.add(ITID_THE_X_RING, 9);
        boss3.add(ITID_GOBLIN_ROCKET_BOOTS_LIMITED_EDITION, 6);
        boss3.add(ITID_WARSONG_BATTLE_DRUMS, 2);
        boss3.add(ITID_TROLL_BANE, 2);
        boss3.add(ITID_CORE_HOUND_TOOTH, 3);
        boss3.add(ITID_VISKAG, 8);
        boss3.add(ITID_SIGNET_OF_THE_LAST_DEFENDER, 10);
        boss3.add(ITID_ARANS_SOOTHING_EMERALD, 10);
        boss3.add(ITID_PURE_ARCANE, 9);
        boss3.add(ITID_HEX_SHRUNKEN_HEAD, 6);
        boss3.add(ITID_TIDAL_LOOP, 10);
        boss3.add(ITID_EAGLE_GOD_GAUNTLETS, 2);
        boss3.add(ITID_MOONSTONE, 12);

        boss4.add(ITID_SCEPTER, 15);
        boss4.add(ITID_WARSONG_BATTLE_DRUMS, 7);
        boss4.add(ITID_TROLL_BANE, 11);
        boss4.add(ITID_GOREHOWL, 7);
        boss4.add(ITID_SIGNET_OF_THE_LAST_DEFENDER, 9);
        boss4.add(ITID_HEX_SHRUNKEN_HEAD, 9);
        boss4.add(ITID_STAFF_OF_THE_SHADOW_FLAME, 9);
        boss4.add(ITID_TIDAL_LOOP, 4);
        boss4.add(ITID_EAGLE_GOD_GAUNTLETS, 9);
        boss4.add(ITID_MOONSTONE, 4);
        boss4.add(ITID_SHADOW_ORB, 16);

        boss5.add(ITID_MAUL, 11);
        boss5.add(ITID_COLOSSUS_BLADE, 4);
        boss5.add(ITID_GOBLIN_ROCKET_BOOTS_LIMITED_EDITION, 3);
        boss5.add(ITID_WARSONG_BATTLE_DRUMS, 9);
        boss5.add(ITID_TROLL_BANE, 8);
        boss5.add(ITID_GOREHOWL, 8);
        boss5.add(ITID_CORE_HOUND_TOOTH, 9);
        boss5.add(ITID_LION_HORN, 7);
        boss5.add(ITID_ARMOR_OF_THE_DAMNED, 10);
        boss5.add(ITID_BULWARK_OF_THE_AMANI_EMPIRE, 13);
        boss5.add(ITID_SIGNET_OF_THE_LAST_DEFENDER, 6);
        boss5.add(ITID_ARANS_SOOTHING_EMERALD, 4);
        boss5.add(ITID_STAFF_OF_THE_SHADOW_FLAME, 2);
        boss5.add(ITID_MOONSTONE, 3);
        boss5.add(ITID_SHADOW_ORB, 3);

        boss6.add(ITID_MAUL, 6);
        boss6.add(ITID_CLOAK, 4);
        boss6.add(ITID_COLOSSUS_BLADE, 5);
        boss6.add(ITID_WARSONG_BATTLE_DRUMS, 8);
        boss6.add(ITID_GOREHOWL, 10);
        boss6.add(ITID_CORE_HOUND_TOOTH, 11);
        boss6.add(ITID_VISKAG, 9);
        boss6.add(ITID_LION_HORN, 5);
        boss6.add(ITID_ARMOR_OF_THE_DAMNED, 8);
        boss6.add(ITID_BULWARK_OF_THE_AMANI_EMPIRE, 10);
        boss6.add(ITID_SIGNET_OF_THE_LAST_DEFENDER, 1);
        boss6.add(ITID_ARANS_SOOTHING_EMERALD, 10);
        boss6.add(ITID_HEX_SHRUNKEN_HEAD, 7);
        boss6.add(ITID_SHADOW_ORB, 6);

        boss7.add(ITID_CLOAK, 7);
        boss7.add(ITID_SCEPTER, 9);
        boss7.add(ITID_COLOSSUS_BLADE, 4);
        boss7.add(ITID_THE_X_RING, 5);
        boss7.add(ITID_GOBLIN_ROCKET_BOOTS_LIMITED_EDITION, 5);
        boss7.add(ITID_WARSONG_BATTLE_DRUMS, 5);
        boss7.add(ITID_TROLL_BANE, 4);
        boss7.add(ITID_GOREHOWL, 5);
        boss7.add(ITID_CORE_HOUND_TOOTH, 4);
        boss7.add(ITID_VISKAG, 5);
        boss7.add(ITID_LION_HORN, 5);
        boss7.add(ITID_ARMOR_OF_THE_DAMNED, 5);
        boss7.add(ITID_BULWARK_OF_THE_AMANI_EMPIRE, 4);
        boss7.add(ITID_SIGNET_OF_THE_LAST_DEFENDER, 4);
        boss7.add(ITID_PURE_ARCANE, 5);
        boss7.add(ITID_STAFF_OF_THE_SHADOW_FLAME, 5);
        boss7.add(ITID_TIDAL_LOOP, 4);
        boss7.add(ITID_EAGLE_GOD_GAUNTLETS, 5);
        boss7.add(ITID_MOONSTONE, 4);
        boss7.add(ITID_SHADOW_ORB, 6);
    }
