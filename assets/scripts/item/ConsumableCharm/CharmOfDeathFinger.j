...
library CharmOfDeathFinger requires SpellEvent, ZAMCore, DamageSystem {
    ...
    function onCast() {
        ...
        DamageTarget(SpellEvent.CastingUnit, SpellEvent.TargetUnit, amt, SpellData.inst(SID_CHARM_OF_DEATH_FINGER, SCOPE_PREFIX).name, false, true, false, WEAPON_TYPE_WHOKNOWS);  
