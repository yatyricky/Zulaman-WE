...
//*****************************************************************
    ...
    struct vector
        ...
        method pointToUnit takes unit u returns nothing
            call MoveLocation(vector.loc, GetUnitX(u), GetUnitY(u))
            set this.x = GetLocationX(vector.loc)
            set this.y = GetLocationY(vector.loc)
            set this.z = GetLocationZ(vector.loc) + GetUnitFlyHeight(u)
        endmethod
