...
library ForceSight {
    ...
    public constant real value_CAMERA_FIELD_FARZ = 5500;
    public constant real value_CAMERA_FIELD_FIELD_OF_VIEW = 70;
    public constant real value_CAMERA_FIELD_ROLL = 0;
    public constant real value_CAMERA_FIELD_ROTATION = 90;
    public constant real value_CAMERA_FIELD_TARGET_DISTANCE = 2500.00;
