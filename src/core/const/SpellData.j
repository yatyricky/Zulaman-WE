...
SpellData.create(SID_SHADOW_SHIFT,"暗影转换",0,0,0,OrderId("w"),1,ORDER_TYPE_TARGET);
...
SpellData.create(SID_NETHER_BREATH,"虚空吐息",0,0,0,OrderId("w"),1,ORDER_TYPE_IMMEDIATE);
...
SpellData.create(SID_POISON_DART,"毒液箭",0,0,0,OrderId("w"),1,ORDER_TYPE_POINT);
