...
ModelInfo.rg(UTIDNAGASEAWITCH,  ATT_AGI,    94899,  190,    200,    5,  0.05,   0.0,    0.0,    1.0,    0.03,   CAREER_TYPE_BOSS,   "ReplaceableTextures\\CommandButtons\\BTNNagaSeaWitch.blp").setScale(1.7);
ModelInfo.rg(UTID_FLYING_SERPENT,   ATT_NON,    1499,   21, 59, 5,  0.05,   0.0,    0.0,    1.0,    0.1,    CAREER_TYPE_CREEP,  "ReplaceableTextures\\CommandButtons\\BTNWindSerpent.blp");
