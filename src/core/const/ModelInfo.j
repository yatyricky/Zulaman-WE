...
ModelInfo.rg(UTIDLIGHTNINGTOTEM,ATT_NON,99,1,0,0,0,0,0,1,0,CAREER_TYPE_MINION,"ReplaceableTextures\\CommandButtons\\BTNStasisTrap.blp");
...
ModelInfo.rg(UTIDWARLOCK,ATT_INT,399899,970,500,5,0.05,0,0,1,0.03,CAREER_TYPE_BOSS,"ReplaceableTextures\\CommandButtons\\BTNOrcWarlock.blp");
...
ModelInfo.rg(UTIDHEXLORD,ATT_INT,799899,1350,700,5,0.05,0,0,1,0.03,CAREER_TYPE_BOSS,"ReplaceableTextures\\CommandButtons\\BTNShadowHunter.blp");
